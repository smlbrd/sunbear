...
export default function SearchForm({
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="flex flex-col sm:flex-row justify-center gap-2 w-full lg:w-5/6 mx-auto p-4 mt-8"
    >
      ...
      />
      <button
        className={`bg-gradient-to-b from-blue-400 to-blue-600 text-white py-2 px-4 rounded-lg transition-colors duration-200 font-medium sm:w-1/6 ${
